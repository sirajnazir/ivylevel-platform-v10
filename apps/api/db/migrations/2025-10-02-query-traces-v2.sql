...
DROP TABLE IF EXISTS query_trace_events CASCADE;
DROP TABLE IF EXISTS query_traces CASCADE;
DROP VIEW IF EXISTS recent_traces CASCADE;
DROP FUNCTION IF EXISTS get_trace_details CASCADE;
