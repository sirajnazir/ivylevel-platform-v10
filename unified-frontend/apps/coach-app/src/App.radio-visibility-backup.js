    ...
    return (
      ...
      <style>{`
        ...
        input[type="radio"]:focus {
          outline: none !important;
          box-shadow: 0 0 0 3px rgba(255, 74, 35, 0.1) !important;
          border-color: #FF4A23;
        }
              ...
              <div key={question.id} style={{background: '#f3f4f6', borderRadius: '8px', padding: '24px'}}>
                ...
                <div style={{display: 'flex', flexDirection: 'column', gap: '12px'}}>
                  {question.options.map((option, idx) => (
                    ...
                    >
                      <input type="radio" style={{outline: 'none', boxShadow: 'none', WebkitAppearance: 'none', MozAppearance: 'none', appearance: 'none'}} onFocus={(e) => { e.target.style.outline = 'none'; e.target.style.boxShadow = '0 0 0 3px rgba(255, 74, 35, 0.1)'; }} onBlur={(e) => { e.target.style.boxShadow = 'none'; }}
                        name={question.id}
                        value={idx}
