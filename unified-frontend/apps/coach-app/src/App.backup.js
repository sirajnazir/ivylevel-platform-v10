    ...
    <div style={{minHeight: '100vh', background: '#F5F5F5'}}>
      ...
      <div style={{background: 'white', borderBottom: '1px solid #e5e7eb', padding: '16px 24px'}}>
        <div style={{maxWidth: '1200px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
          <div style={{display: 'flex', alignItems: 'center', gap: '12px'}}>
            <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
              <IvylevelLogoSmall style={{height: '32px'}} />
              <div style={{fontSize: '1.5rem', fontWeight: 'bold', color: '#020202'}}>Ivylevel</div>
            </div>
            ...
            {modules.map((module, idx) => (
              <div key={module.id} style={{flex: 1, textAlign: 'center'}}>
                <div style={{
                  ...
                  justifyContent: 'center',
                  fontSize: '1.5rem',
                  background: completedModules.includes(module.id) ? '#319795' :
                    ...
                    <div key={idx}>
                      ...
                      {showFeedback && scenarioResponses[scenario.id]?.index === idx && (
                        <div style={{
                          ...
                          borderRadius: '8px',
                          fontSize: '0.875rem',
                          background: response.score === 100 ? '#E6FFFA' : 
          ...
          {!showFeedback ? (
            ...
            <div style={{textAlign: 'center', padding: '32px 0'}}>
              <div style={{
                ...
                borderRadius: '50%',
                marginBottom: '24px',
                background: masteryScore >= 80 ? '#E6FFFA' : masteryScore >= 60 ? '#fef3c7' : '#fecaca'
              }}>
                <div style={{textAlign: 'center'}}>
                  <div style={{
                    fontSize: '2.5rem',
            ...
            {validation.status === 'pending' ? (
              ...
              <div>
                <div style={{
                  ...
                  borderRadius: '8px',
                  marginBottom: '16px',
                  background: validation.status === 'success' ? '#E6FFFA' : '#fecaca'
                }}>
                  <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
            ...
            <div>
              ...
              <div style={{background: '#111827', borderRadius: '8px', padding: '16px', marginBottom: '24px'}}>
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px'}}>
                  <div style={{display: 'flex', alignItems: 'center', gap: '16px'}}>
                    <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
                      <div style={{width: '12px', height: '12px', background: '#319795', borderRadius: '50%', animation: 'pulse 2s infinite'}}></div>
          ...
          {simulationState === 'review' && (
            <div style={{textAlign: 'center', padding: '32px 0'}}>
              <div style={{
                ...
                borderRadius: '50%',
                marginBottom: '24px',
                background: calculateOverallScore() >= 85 ? '#E6FFFA' :
                    ...
                    <div key={scenario.id} style={{
                      ...
                      <div style={{display: 'flex', alignItems: 'center', gap: '12px'}}>
                        <div style={{
                          ...
                          alignItems: 'center',
                          justifyContent: 'center',
                          background: scenarioScore[scenario.id] >= 80 ? '#E6FFFA' :
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: '24px'}}>
            ...
            <div style={{background: '#f3f4f6', borderRadius: '8px', padding: '24px'}}>
              ...
              {!pledgeRecorded ? (
                ...
                <div style={{background: '#E6FFFA', border: '1px solid #4FD1C5', borderRadius: '8px', padding: '16px'}}>
                  <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
              ...
              <div key={scenario.id} style={{background: 'white', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '24px'}}>
                ...
                {emergencyQuizAnswers[scenario.id] !== undefined && (
                  <div style={{
                    padding: '16px',
                    borderRadius: '8px',
                    background: emergencyQuizAnswers[scenario.id] === scenario.correct ? '#E6FFFA' : '#fecaca',
        ...
        return (
          <div style={{display: 'flex', flexDirection: 'column', gap: '24px'}}>
            ...
            <div style={{background: 'white', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '24px'}}>
              ...
              {sessionScheduled && (
                <div style={{marginTop: '16px', padding: '16px', background: '#E6FFFA', border: '1px solid #4FD1C5', borderRadius: '8px'}}>
                  <div style={{display: 'flex', alignItems: 'center', gap: '8px'}}>
                    <CheckCircle style={{color: '#FF4A23'}} />
