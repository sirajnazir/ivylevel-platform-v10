...
// Brand Logo Components - Same as enhanced coach app
const IvylevelFullLogo = ({ style = {} }) => (
  <svg style={{width: '200px', height: '60px', ...style}} viewBox="0 0 92 27" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const EntryPortal = () => {
  ...
  const handleNavigation = (persona) => {
    setLoading(true);
    ...
    setTimeout(() => {
      if (persona === 'student') {
        ...
        window.location.href = 'http://localhost:3003'; // Enhanced coach app
      }
    }, 300);
  };
  ...
  const styles = {
    container: {
      ...
      background: 'linear-gradient(135deg, #FF4A23 0%, #FF6B47 100%)',
      position: 'relative',
      overflow: 'hidden',
    ...
    card: {
      ...
      borderRadius: '24px',
      padding: '80px',
      boxShadow: '0 20px 60px rgba(100, 20, 50, 0.3)',
      textAlign: 'center',
      maxWidth: '600px',
      width: '90%',
      position: 'relative',
  ...
  return (
    <div style={styles.container} onMouseMove={handleMouseMove}>
      ...
      <div style={styles.card}>
        ...
        <h1 style={styles.title}>Welcome to IvyLevel</h1>
        <p style={styles.subtitle}>Your AI-powered path to elite college admissions</p>

        <div>
          <span style={styles.personaLabel}>Choose your journey:</span>
          ...
          <div style={styles.buttonGroup}>
            <button
              ...
              onMouseEnter={(e) => {
                e.target.style.background = '#FF6B47';
                e.target.style.transform = 'translateY(-4px)';
                e.target.style.boxShadow = '0 12px 24px rgba(255, 74, 35, 0.3)';
              }}
              onMouseLeave={(e) => {
                e.target.style.background = '#FF4A23';
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.target.style.background = '#7a1a3e';
                e.target.style.transform = 'translateY(-4px)';
                e.target.style.boxShadow = '0 12px 24px rgba(100, 20, 50, 0.3)';
              }}
              onMouseLeave={(e) => {
                e.target.style.background = '#641432';
                e.target.style.transform = 'translateY(0)';
                e.target.style.boxShadow = 'none';
              }}
            >
        ...
        <div style={styles.demoInfo}>
          ...
          <div style={styles.demoCredentials}>
            Student: demo@student.com | pass123<br />
            Coach: demo@coach.com | pass123
          </div>
        </div>
      </div>
