...
Fixed version that handles JSON files properly.
"""
import os
import sys
import json
        ...
        try:
            ...
            for item in items:
                ...
                if item['mimeType'] in ['application/vnd.google-apps.document',
                    ...
                    # FIXED: For JSON files, export as plain text
                    if item['name'].endswith('.json'):
                        ...
                        try:
                            ...
                            print(f"    Error exporting as text: {e}")
                    else:
                        # Export other Google Docs as PDF
                        try:
                            request = service.files().export_media(
                                fileId=item['id'],
