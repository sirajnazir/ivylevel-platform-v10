...
## v2 Additions
- 24 chips spanning trust-building, rejection alchemy, summer transformation, and application climax.
- Retrieval guardrails to avoid conflicts with Session chips.
