...
export abstract class BaseAgentWithIntelligence {
  ...
  protected detectFrustration(
    ...
    if (analysis.is_frustrated) {
      ...
      console.log(`[v36.0 FRUSTRATION] Detected in user response: ${analysis.frustration_level}`);
      console.log(`[v36.0 FRUSTRATION] Signals: ${analysis.signals_detected.join(', ')}`);
      console.log(`[v36.0 FRUSTRATION] Suggested action: ${analysis.suggested_action}`);
    }
